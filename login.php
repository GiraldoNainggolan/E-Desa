...
<body class="flex items-center justify-center min-h-screen">
    <div class="form-container w-full max-w-md mx-4 fade-in">
        <div class="text-center mb-6">
            ...
            <h2 class="text-xl font-semibold text-gray-600">Masuk ke Akun Anda</h2>
        </div>
        ...
        <form method="POST" class="space-y-4">
            <div class="form-group">
                ...
                <input type="text" name="nik" class="form-input" placeholder="Masukkan NIK Anda" required>
            </div>
        ...
        <div class="text-center mt-6">
            <p class="text-gray-600">Belum punya akun? 
                <a href="register.php" class="text-blue-600 hover:text-blue-800 font-medium">Daftar di sini</a>
            </p>
